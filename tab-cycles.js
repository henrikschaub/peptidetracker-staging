...
function _cwizCapture(){
  ...
  _cwiz.compounds.forEach(function(c,i){
    ...
    var de=document.getElementById('cwiz-cd-'+i);if(de)c.dose=parseFloat(de.value)||0;
