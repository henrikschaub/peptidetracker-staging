...
function renderMacros(bw){
  ...
  h+='<div class="card-body" style="gap:12px"><div style="display:grid;gap:4px"><label style="font-size:12px;font-weight:700;color:var(--text);text-transform:uppercase;letter-spacing:0.5px">Training Time</label>';
  ...
  var slots=[{t:ofT(tH,tM,-1,-30),icon:'&#x26A1;',label:'Pre-training',macro:'Fast carbs + light protein',detail:'Rice cakes, OJ, banana. Prime glycogen; do not eat heavy fat.',col:'var(--accent2)'},{t:ofT(tH,tM,0,0),icon:'&#x1F3CB;',label:'Intra (training)',macro:'Optional fast carbs only if session &gt;75 min',detail:'Dextrose / Gatorade. Skip if short session.',col:'var(--accent)'},{t:ofT(tH,tM,0,30),icon:'&#x1F504;',label:'Post-training',macro:'Protein + fast carbs ASAP',detail:'Shake + fruit / white rice. Do not delay this window.',col:'var(--accent3)'},{t:ofT(tH,tM,4,0),icon:'&#x1F319;',label:'Pre-sleep',macro:'Slow protein + complex carbs',detail:'Cottage cheese / casein + oats. Sustains GH pulse, prevents catabolism.',col:'var(--accent4)'}];
  slots.forEach(function(s){
    ...
    h+='<div style="flex:1"><div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:3px"><span style="font-size:13px;font-weight:700;color:var(--text)">'+s.label+'</span><span style="font-size:12px;color:'+s.col+';font-weight:700">'+s.t+'</span></div>';
